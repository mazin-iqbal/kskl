...
export default function Login( {navigation} ) {
    ...
    function navigateToLoginBM() {
        navigation.navigate('LoginBM');
    }
    ...
    async function LoginUser(){
      ...
      .then((userCredential) => {
        ...
        console.log("func ke ander user: ", user)
        // const uid = user.uid
        ...
        //         if (doc.data().userType === "user"){
            navigation.navigate('Dashboard', {userInfo: user});
           ...
           <View style={styles.FormView}>
                ...
                <TextInput placeholder={'Password'} secureTextEntry={true} style={styles.TextInput} onChangeText={text=>{setPassword(text)}}/>
                    ...
                    <TouchableOpacity style={styles.Button1} onPress={navigateToLoginBM}>
                        <Text style={{color: '#fff', fontWeight: 'bold', fontSize:18}}>LogIn as Branch Manager</Text>
                    </TouchableOpacity>
